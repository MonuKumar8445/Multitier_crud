    ...
    public class EmployeeDataAccess
    {
        ...
        public List<Employee>GetEmployees()
        {
           ...
           if(db.connection.State==System.Data.ConnectionState.Closed)
            ...
            while(reader.Read())
            {
                ...
                employee.Adhar_no = reader["Adhar_no"].ToString();
        ...
        public bool InsertEmployee(Employee employee)
        {
            string query = "insert into Employee values ('" + employee.Name + "'," +"'" + employee.Age + "','" + employee.Salary + "'," +
                "'" + employee.Phone + "','"+employee.City+ "','" + employee.Email + "','" 
                + employee.Adhar_no + "')";
        ...
        public bool UpdateEmployee(Employee employee)
        {
            string query = "update Employee set Name='" + employee.Name + "',Age='" + employee.Age + "'," +
                "Salary='" + employee.Salary + "',Phone='" + employee.Phone + "',City='" + employee.City +
                "',Email='" + employee.Email + "',Adhar_no='" + employee.Adhar_no + "' where id='" + employee.id+"'";
            SqlCommand command = new SqlCommand(query, db.connection);
            if (db.connection.State == System.Data.ConnectionState.Closed)
                db.connection.Open();
            int i = command.ExecuteNonQuery();
